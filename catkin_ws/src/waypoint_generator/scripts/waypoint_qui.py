...
class WaypointGui:
    def __init__(self, master):
        self.master = master
        self.master.title("Add Waypoints")

        # Create two frames for waypoints
        self.waypoint1_frame = LabelFrame(master, text="Waypoint 1")
        self.waypoint1_frame.pack(padx=10, pady=10, fill="both", expand=True)

        self.waypoint2_frame = LabelFrame(master, text="Waypoint 2")
        ...
        # Update the plot
        self.custom_button = Button(master, text="Update the plot", command=self.publish_custom_message)
        self.custom_button.pack(side="top", fill='both', expand=True, padx=10, pady=10)
    ...
    def submit_waypoint(self, suffix):
        ...
        try:
            ...
            if suffix == '1':
                ...
                goal_waypoints.append(pose_msg)
