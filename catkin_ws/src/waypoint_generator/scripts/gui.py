...
class WaypointGui:
    def __init__(self, master):
        ...
        self.waypoint1_frame = LabelFrame(master, text="Add a global waypoint to the goal_waypoint list")
        self.waypoint1_frame.pack(padx=10, pady=10, fill="both", expand=True)

        self.waypoint2_frame = LabelFrame(master, text="Add a waypoint relative to the last waypoint added to the goal_waypoint_list")
